...
public class AddAttandanceSessionActivity<AddAttandanceActivity> extends Activity {
	...
	String branch = "CS";
	String year = "1,2,3";
	String subject = "Dev Mobile Cours, Dev Mobile TP";

	private String[] branchString = new String[] { "CS"};
	private String[] yearString = new String[] {"01","02","03"};
	...
	private String[] subjectFinal = new String[] {"DMC","DMTD","DMTP","CN","M5","NS"};
